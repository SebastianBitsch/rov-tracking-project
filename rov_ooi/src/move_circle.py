...
def move_circle(model_name: str, speed: float, radius: float, depth: float):
    """
    ...
    Args:
        ...
        radius (float): The radius of the circle to move in
        depth (float): The depth at which to move in circles
    ...
    state_msg.pose.position.z = depth
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Move object
        move_circle(model_name = model_name, speed = movement_speed, radius = movement_radius, depth = depth)
